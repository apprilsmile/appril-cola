...
(
    ...
    MVN archetype:generate \
        -DgroupId=com.appril.cola.demo.archetype-service \
        -DartifactId="$artifactId" \
        -Dversion=1.0.0-SNAPSHOT \
        -Dpackage=com.appril.cola.demo.service \
...
(
    ...
    MVN archetype:generate \
        -DgroupId=com.appril.cola.demo.archetype-web \
        -DartifactId="$artifactId" \
        -Dversion=1.0.0-SNAPSHOT \
        -Dpackage=com.appril.cola.demo.web \
        -DarchetypeGroupId=com.appril.cola \
